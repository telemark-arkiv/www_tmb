...
{/if}
    ...
    {/foreach*}
    <meta name="keywords" content="Telemarksbarometeret">
    <meta name="description" content="Gi oss gjerne din tilbakemelding slik at vi kan utvikle siden til å bli et stadig bedre redskap for Telemark.">
